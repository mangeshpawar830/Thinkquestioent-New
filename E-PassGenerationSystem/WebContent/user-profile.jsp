		...
		<div class="w3l-book-9">
			<div class="main-top">
				<div class="wrapper padding-bord">
					...
					<%
						ResultSet rs = DatabaseConnection.getResultFromSqlQuery("select * from tblpatient where user_name='" + session.getAttribute("uname") + "'");
						if (rs.next()) {
					%>
					<form action="" method="">
						<div class="d-grid grid-col-2">
							...
							<div class="ele-9its_grid">
								...
								<input type="text" name="fname" class="input"
									value="<%=rs.getString("patient_full_name")%>" readonly/>
							</div>
						...
						<div class="ele-9its_grid">
								...
								<input type="email" name="email" class="input"
									value="<%=rs.getString("patient_email")%>" readonly/>
							</div>
							<div class="ele-9its_grid">
								<p class="text-left"><strong>Mobile No</strong></p>
								<input type="text" name="mobile" class="input"
									value="<%=rs.getString("Patient_mobile")%>" readonly/>
							</div>
							
						</div>
						<div class="d-grid grid-col-2">
							<div class="ele-9its_grid">
								<p class="text-left"><strong>Disease</strong></p>
								<input type="text" name="disease" class="input"
									value="<%=rs.getString("patient_disease")%>" readonly/>
							</div>
							<div class="ele-9its_grid">
								<p class="text-left"><strong>Address</strong></p>
								<input type="text" name="address" class="input"
									value="<%=rs.getString("patient_address")%>" readonly/>
							</div>
