...
<body>
	...
	<section>
		...
		<div class="main-content main-content4">
					...
					<div class="user-panel-top">
						<div class="profile_details_left">
							<span>E-Pass Generation System</span> | <strong>
								Approved E-Pass Applications</strong>
						</div>
			...
			<div id="page-wrapper">
				<div class="graphs">
					<h4 class="blank1">Approved E-Pass Applications</h4>
					<div class="xs tabls">
							...
							<table class="table">
								...
								<%
									ResultSet resultset = DatabaseConnection
										.getResultFromSqlQuery("select * from tblpatient where e_pass_status='Approved'");
								...
								<tbody>
									<tr class="active">
										...
										<td><span class="label btn_6 label-success"><%=resultset.getString("e_pass_status")%></span></td>
									</tr>
								</tbody>
								<%
									}
