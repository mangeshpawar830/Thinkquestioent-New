	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8">
				...
				<%
					String status = null;
					ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblpatient where user_name='" + session.getAttribute("uname") + "' and e_pass_status!=''");
					if (resultset.next()) {
				%>
				<table class="table table-bordered">
					<tbody>
						...
						<tr>
							...
							<td><font color="red"><%=resultset.getString("source_city")%></font> <b>To</b><font color="red"> <%=resultset.getString("destination_city")%></font> </td>
						</tr>
						<%
				...
				%>
				<div><center><h3><span class="label label-warning">Application Not Found.</span></h3> <a href="apply-epass.jsp">Please click here to apply e-pass.</a></center></div>
				<%
					}
				%>
