...
<%
	...
	<section>
		...
		<div class="main-content main-content4">
				...
				<div class="menu-right">
					<div class="user-panel-top">
						<div class="profile_details_left">
							<span>E-Pass Generation System</span> | <strong> 
								Rejected E-Pass Applications</strong>
						</div>
			...
			<div id="page-wrapper">
				<div class="graphs">
					<h4 class="blank1">Rejected E-Pass Applications</h4>
					<div class="xs tabls">
						<div class="bs-example4" data-example-id="contextual-table">
							<table class="table">
								...
								<%
									ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblpatient where e_pass_status='Rejected'");
								...
								<tbody>
									<tr class="active">
										...
										<td><span class="label btn_6 label-danger"><%=resultset.getString("e_pass_status")%></span></td>
										</tr>
								</tbody>
								<%
									}
